...
function GuildTabard(id, tabard) {
	var self = this,
		...
		context = null,
		_path = '/static/images/guild/tabards/',
		_width = canvas.width,
	...
	self.initialize = function() {
		...
		if (_colorMap[2][tabard.bg[1]] && _colorMap[4][tabard.border[1]] && _colorMap[5][tabard.emblem[1]]) {
			_src = [
				...
				_path + 'shadow_' + (tabard.bg[0] < 10 ? "0" : "") + tabard.bg[0] + '.png',
				//_path + 'bg_' + Core.zeroFill(tabard.bg[0], 2) + '.png',
				_path + 'bg_'  + (tabard.bg[0] < 10 ? "0" : "") + tabard.bg[0] + '.png',
				//_path + 'overlay_' + Core.zeroFill(tabard.bg[0], 2) + '.png',
				_path + 'overlay_'  + (tabard.bg[0] < 10 ? "0" : "") + tabard.bg[0] + '.png',
				//_path + 'border_' + Core.zeroFill(tabard.border[0], 2) + '.png',
				_path + 'border_'  + (tabard.border[0] < 10 ? "0" : "") + tabard.border[0] + '.png',
				//_path + 'emblem_' + Core.zeroFill(tabard.emblem[0], 2) + '.png',
				_path + 'emblem_'  + (tabard.emblem[0] < 10 ? "0" : "") + tabard.emblem[0] + '.png',
				_path + 'hooks.png'
			];
